...
var Metamask = require('assets/icons/metamask.svg');
var WalletConnect = require('assets/icons/walletconnect.svg');
var _ = require('lodash');
var fibswapSdk = require('@fibswap-dex/fibswap-sdk');
require('numeral');
var utils = require('ethers/lib/utils');
var BigNumber = require('bignumber.js');
var simpleUniswapSdk = require('simple-uniswap-sdk');
var toast = require('react-hot-toast');
var Switch = require('@mui/material/Switch');
var reactBootstrap = require('react-bootstrap');
var bignumber = require('@ethersproject/bignumber');
var bytes = require('@ethersproject/bytes');
var utils$1 = require('jotai/utils');
...
var Metamask__default = /*#__PURE__*/_interopDefaultLegacy(Metamask);
...
var BIG_ZERO = ethers.BigNumber.from(0);
...
function IconImage(_a) {
    ...
    return (jsxRuntime.jsx(reactLazyLoadImageComponent.LazyLoadImage, { alt: alt, src: src, effect: "blur", width: width, height: height, className: className, onError: function (e) {
            var target = e.target;
            target.onerror = null;
...
var RefreshContextProvider = function (_a) {
    ...
    var _b = __read(React.useState(0), 2), slow = _b[0], setSlow = _b[1];
    var _c = __read(React.useState(0), 2), fast = _c[0], setFast = _c[1];
    ...
    return jsxRuntime.jsx(RefreshContext.Provider, __assign({ value: { slow: slow, fast: fast } }, { children: children }));
};

var useRefresh = function () {
    var _a = React.useContext(RefreshContext), fast = _a.fast, slow = _a.slow;
...
var TokensContext = React__default["default"].createContext(defaultState$1);
var TokensContextProvider = function (_a) {
    ...
    return jsxRuntime.jsx(TokensContext.Provider, __assign({ value: tokensState }, { children: children }));
};

var useTokens = function () {
    var _a = React.useContext(TokensContext), tokens = _a.tokens, fetchStatus = _a.fetchStatus;
    return {
        tokens: tokens,
...
function TokenSelect(_a) {
    ...
    return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsxs("div", __assign({ className: "select_control temp  d-flex align-items-center justify-content-between ".concat(className) }, { children: [jsxRuntime.jsx("div", __assign({ className: "option d-flex align-items-center me-1" }, { children: selectedItem ? (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("div", __assign({ className: "me-2 select_control_icon flex-grow-1" }, { children: jsxRuntime.jsx(IconImage, { src: selectedItem.image, className: "w-full", alt: selectedItem.symbol, width: 22, height: 22 }) })), jsxRuntime.jsx("div", { children: jsxRuntime.jsx("p", __assign({ className: "option-label mb-0 " }, { children: selectedItem.symbol })) })] })) : (jsxRuntime.jsx("div", { children: jsxRuntime.jsx("p", __assign({ className: "option-label mb-0 " }, { children: "Select" })) })) })), jsxRuntime.jsx(fi.FiChevronDown, {})] })) }));
}
...
var connections = [];
var defaultChainIdAtom = jotai.atom(1);
...
function getConnectorName(connector) {
    if (connector instanceof metamask.MetaMask)
        return "MetaMask";
    if (connector instanceof walletconnect.WalletConnect)
        return "WalletConnect";
    if (connector instanceof network.Network)
        return "Network";
    if (connector instanceof JsonRpcConnector)
        return "JsonRpcConnector";
    if (connector instanceof eip1193.EIP1193)
        return "EIP1193";
    return "Unknown";
}
function getConnectionFromProvider(onError, provider) {
    ...
    if (providers.JsonRpcProvider.isProvider(provider)) {
        return toWeb3Connection(core.initializeConnector(function (actions) { return new JsonRpcConnector(actions, provider); }));
    }
    else if (providers.JsonRpcProvider.isProvider(provider.provider)) {
        throw new Error("Eip1193Bridge is experimental: pass your ethers Provider directly");
    }
    else {
        return toWeb3Connection(core.initializeConnector(function (actions) { return new eip1193.EIP1193({ actions: actions, provider: provider, onError: onError }); }));
    }
}
function getConnectionFromWalletConnect(useDefault, jsonRpcUrlMap, defaultChainId, onError) {
    return toWeb3Connection(core.initializeConnector(function (actions) {
        return new walletconnect.WalletConnect({
            actions: actions,
            options: {
                rpc: jsonRpcUrlMap,
                qrcode: useDefault,
...
function ActiveWeb3Provider(_a) {
    ...
    var _b = __read(jotai.useAtom(defaultChainIdAtom), 2), defaultChainId = _b[0], setDefaultChainId = _b[1];
    React.useEffect(function () {
    ...
    var integratorConnection = React.useMemo(function () { return getConnectionFromProvider(onError, provider); }, [onError, provider]);
    var metaMaskConnection = React.useMemo(function () { return toWeb3Connection(core.initializeConnector(function (actions) { return new metamask.MetaMask({ actions: actions, onError: onError }); })); }, [onError]);
    var walletConnectConnectionQR = React.useMemo(function () { return getConnectionFromWalletConnect(false, jsonRpcUrlMap, defaultChainId, onError); }, [jsonRpcUrlMap, defaultChainId, onError]); // WC via tile QR code scan
    var walletConnectConnectionPopup = React.useMemo(function () { return getConnectionFromWalletConnect(true, jsonRpcUrlMap, defaultChainId, onError); }, [jsonRpcUrlMap, defaultChainId, onError]); // WC via built-in popup
    var networkConnection = React.useMemo(function () {
        return toWeb3Connection(core.initializeConnector(function (actions) { return new network.Network({ actions: actions, urlMap: jsonRpcUrlMap, defaultChainId: defaultChainId }); }));
    ...
    return (jsxRuntime.jsx(core.Web3ReactProvider, __assign({ connectors: connections }, { children: children }), key));
}
...
function WalletConnectButton(_a) {
    ...
    var defaultChainId = jotai.useAtomValue(defaultChainIdAtom);
    var _c = __read(React.useState(""), 2), qrUri = _c[0], setQrUri = _c[1];
    var _d = __read(React.useState(""), 2), qrCodeSvg = _d[0], setQrCodeSvg = _d[1];
    React.useEffect(function () {
        var stale = false;
        if (qrUri) {
    ...
    React.useEffect(function () {
        ...
        walletConnect.events.on(walletconnect.URI_AVAILABLE, function (uri) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (uri) {
                    setQrUri(uri);
                }
        ...
        return function () {
            var _a, _b;
            walletConnect.events.off(walletconnect.URI_AVAILABLE);
            (_b = (_a = walletConnect.provider) === null || _a === void 0 ? void 0 : _a.connector) === null || _b === void 0 ? void 0 : _b.off("display_uri", uriListener);
        };
    });
    return (jsxRuntime.jsxs("div", __assign({ className: "wallet-item", onClick: onClick }, { children: [jsxRuntime.jsxs("p", __assign({ className: "d-flex align-items-center justify-content-between white" }, { children: [jsxRuntime.jsx("span", { children: walletName }), jsxRuntime.jsx("img", { src: logoSrc, width: "30" })] })), jsxRuntime.jsx(QRCodeWrapper, { dangerouslySetInnerHTML: { __html: qrCodeSvg } })] })));
}
function MetaMaskButton(_a) {
    var walletName = _a.walletName, logoSrc = _a.logoSrc, onClick = _a.onClick;
    return (jsxRuntime.jsx("div", __assign({ className: "wallet-item", onClick: onClick }, { children: jsxRuntime.jsxs("p", __assign({ className: "d-flex align-items-center justify-content-between white" }, { children: [jsxRuntime.jsx("span", { children: walletName }), jsxRuntime.jsx("img", { src: logoSrc, width: "30" })] })) })));
}
var ConnectWalletModal = function (props) {
    var _a = __read(connections[0], 1), firstConnector = _a[0];
    var integratorProvidedConnector = firstConnector instanceof eip1193.EIP1193 || firstConnector instanceof url.Url;
    var _b = __read(integratorProvidedConnector
        ? connections.slice(1)
        : connections, 3), mmConnection = _b[0], wcTileConnection = _b[1], wcPopupConnection = _b[2];
    var defaultChainId = jotai.useAtomValue(defaultChainIdAtom);
    var activateWalletConnectPopup = React.useCallback(function () {
        var _a;
    ...
    var activateMetaMask = React.useCallback(function () {
        var _a;
    ...
    return (jsxRuntime.jsx("div", __assign({ className: "select_options" }, { children: jsxRuntime.jsxs("div", __assign({ className: "wallet-items" }, { children: [jsxRuntime.jsx(WalletConnectButton, { walletName: "WalletConnect", logoSrc: connectors[1].icon, connection: wcTileConnection, onClick: activateWalletConnectPopup }), jsxRuntime.jsx(MetaMaskButton, { walletName: "MetaMask", logoSrc: connectors[0].icon, onClick: activateMetaMask })] })) })));
};
...
var isSupportedLocalToken = function (chainId, token) {
    var e_5, _a;
    var _b, _c, _d;
    if (!isSupportedChain(chainId) || !utils.isAddress(token)) {
        return false;
    }
    try {
...
var useNxtpSdk = function (trigger) {
    var _a = __read(React.useState(), 2), sdk = _a[0], setSdk = _a[1];
    var _b = __read(React.useState(), 2), assetBalances = _b[0], setAssetBalances = _b[1];
    var _c = __read(React.useState([]), 2), swapTransfers = _c[0], setSwapTransfers = _c[1];
    var _d = __read(React.useState([]), 2), paymentTransfers = _d[0], setPaymentTransfers = _d[1];
    var _e = core.useWeb3React(), account = _e.account, provider = _e.provider;
    React.useEffect(function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fibswapSdk.create({
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        response = _a.sent();
                        if (response) {
                            data = ___default["default"].groupBy(response.map(function (l) {
...
var useChainProviders = function () {
    var _a = __read(React.useState({}), 2), chainProviders = _a[0], setChainProviders = _a[1];
    React.useEffect(function () {
        var tempProviders = {};
        Object.entries(CHAIN_CONFIG).forEach(function (_a) {
            ...
            tempProviders[parseInt(chainId)] = {
                provider: new ethers.providers.FallbackProvider(provider_params.rpcUrls.map(function (p) { return new ethers.providers.JsonRpcProvider(p, parseInt(chainId)); })),
                multicall: multicall,
...
var TokenPriceContext = React__default["default"].createContext(defaultState);
var TokenPriceContextProvider = function (_a) {
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, axios__default["default"].get("https://api.coingecko.com/api/v3/simple/price?ids=".concat(Object.values(ids).join(","), "&vs_currencies=usd"))];
                    case 1:
                        res = _f.sent();
                        tempPrices = {};
                        try {
    ...
    return jsxRuntime.jsx(TokenPriceContext.Provider, __assign({ value: priceState }, { children: children }));
};

var useNativeTokenPrices = function () {
    var _a = React.useContext(TokenPriceContext), nativeTokenPrices = _a.nativeTokenPrices, fetchStatus = _a.fetchStatus;
    return {
...
var useTokenPrices = function (assets) {
    var _a = __read(React.useState({}), 2), priceState = _a[0], setPriceState = _a[1];
    var chainProviders = useChainProviders().chainProviders;
    React.useEffect(function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 2:
                        ...
                        if (!(ethers.utils.isAddress(asset.assetId) && asset.chainId && chain_id)) return [3 /*break*/, 7];
                        _e.label = 3;
                    case 3:
                        _e.trys.push([3, 5, , 6]);
                        return [4 /*yield*/, axios__default["default"].get("https://api.coingecko.com/api/v3/coins/".concat(chain_id, "/contract/").concat(asset.assetId.toLowerCase()))];
                    case 4:
                        res = _e.sent();
...
var getDecimalAmount = function (amount, decimals) {
    ...
    return ethers.utils.parseUnits(new BigNumber.BigNumber(amount).toFixed(decimals).toString(), decimals);
};
...
var getPairSettings = function (chainId, slippage) {
    ...
    switch (chainId) {
        case 1:
            return [
                new simpleUniswapSdk.UniswapPairSettings({
                    slippage: slippage,
                    deadlineMinutes: DEFAULT_DEADLINE_MINUTES,
                    disableMultihops: false,
                    uniswapVersions: [simpleUniswapSdk.UniswapVersion.v2, simpleUniswapSdk.UniswapVersion.v3],
                }),
            ];
        case 4:
            return [
        ...
        case 56:
            return [
                new simpleUniswapSdk.UniswapPairSettings({
                    ...
                    deadlineMinutes: DEFAULT_DEADLINE_MINUTES,
                    disableMultihops: false,
                    uniswapVersions: [simpleUniswapSdk.UniswapVersion.v2],
...
var getTradeInfo = function (chainId, fromToken, toToken, account, amount, isExactInput, slippage) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                _c.trys.push([1, 4, , 5]);
                uniswapPair = new simpleUniswapSdk.UniswapPair({
                    fromTokenContractAddress: fromToken === ZERO_ADDRESS ? getWrappedToken(chainId) : fromToken,
                    toTokenContractAddress: toToken === ZERO_ADDRESS ? simpleUniswapSdk.appendEthToContractAddress(getWrappedToken(chainId)) : toToken,
                    ethereumAddress: account,
                    chainId: chainId,
                    providerUrl: ___default["default"].sample(chainInfo.provider_params.rpcUrls),
            ...
            case 2:
                ...
                return [4 /*yield*/, uniswapPairFactory.trade(String(amount), isExactInput ? simpleUniswapSdk.TradeDirection.input : simpleUniswapSdk.TradeDirection.output)];
            case 3:
                trade = _c.sent();
...
var getSwapEstimate = function (tokens, bridgeState, liquidity, nativePrices, slippage) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                bridge = ___default["default"].cloneDeep(bridgeState);
                ...
                if (!utils.isAddress(fromFibswap) || !utils.isAddress(toFibswap)) {
                    ...
                    return __generator(this, function (_f) {
                        switch (_f.label) {
                            case 0:
                                ...
                                recvLocalLiquidity = ethers.BigNumber.from(((_d = (_c = liquidity[toChainId]) === null || _c === void 0 ? void 0 : _c.find(function (l) { return l.router_address === routerAddress && equals_ignore_case(l.local, recvLocal_1.contract_address); })) === null || _d === void 0 ? void 0 : _d.amount) || "0");
                    ...
                    return __generator(this, function (_h) {
                        switch (_h.label) {
                            case 0:
                                ...
                                senderLiquidity = ethers.BigNumber.from(((_d = (_c = liquidity === null || liquidity === void 0 ? void 0 : liquidity[fromChainId]) === null || _c === void 0 ? void 0 : _c.find(function (l) { return l.router_address === routerAddress && equals_ignore_case(l.local, senderLocal.contract_address); })) === null || _d === void 0 ? void 0 : _d.amount) || "0");
                                recvLiquidity = ethers.BigNumber.from(((_f = (_e = liquidity === null || liquidity === void 0 ? void 0 : liquidity[toChainId]) === null || _e === void 0 ? void 0 : _e.find(function (l) { return l.router_address === routerAddress && equals_ignore_case(l.local, recvLocal.contract_address); })) === null || _f === void 0 ? void 0 : _f.amount) || "0");
                            ...
                            case 4:
                                ...
                                bridge.isEth = true;
                                return [3 /*break*/, 7];
                            case 5: return [4 /*yield*/, getTradeInfo(toChainId, bridge.toLocal, bridge.toTransacting, bridge.originSender, parseFloat(new BigNumber.BigNumber(bridge.localAmount).minus(1e-6).toFixed(selectedSenderLocal.contract_decimals)), true, DEFAULT_DESTINATION_SLIPPAGE)];
                            case 6:
                                toQuote = _h.sent();
...
var getAmountWithOutFee = function (amount, decimals) {
    return parseFloat(new BigNumber.BigNumber(amount)
...
var parseFibswapError = function (errorData) {
    var iErrors = new utils.Interface(fibswapAbi);
    if (!errorData) {
        return null;
    }
    if (errorData.startsWith("0x08c379a0")) {
        ...
        var reason = ethers.utils.defaultAbiCoder.decode(["string"], content);
        return reason[0]; // reason: string; for standard revert error string
    }
    if (errorData.startsWith("0x4e487b71")) {
        // decode Panic(uint)
        var content = "0x".concat(errorData.substring(10));
        var code = ethers.utils.defaultAbiCoder.decode(["uint"], content);
        return code[0];
    }
    try {
...
var useGasPrices = function (chainId) {
    var _a = __read(React.useState(0), 2), priceState = _a[0], setPriceState = _a[1];
    var chainProviders = useChainProviders().chainProviders;
    var fetchEthGas = function () {
        return axios__default["default"]
            ...
            var _a, _b;
            return ethers.BigNumber.from((_b = (_a = response === null || response === void 0 ? void 0 : response.data) === null || _a === void 0 ? void 0 : _a.medium) === null || _b === void 0 ? void 0 : _b.maxFeePerGas)
                .div(Math.pow(10, 9))
                .toNumber();
        })
            .catch(function () {
            return axios__default["default"].get("https://ethgasstation.info/api/ethgasAPI.json").then(function (response) {
...
var useGetEthBalance = function (chainId) {
    var _a = __read(React.useState(BIG_ZERO), 2), balance = _a[0], setBalance = _a[1];
...
var useTokenBalances = function (chainId) {
    ...
    var validatedTokens = React.useMemo(function () { var _a; return (_a = tokens === null || tokens === void 0 ? void 0 : tokens.filter(function (t) { return utils.isAddress(t === null || t === void 0 ? void 0 : t.address) !== false && (t === null || t === void 0 ? void 0 : t.address) !== ZERO_ADDRESS; })) !== null && _a !== void 0 ? _a : []; }, [tokens]);
...
function useCurrencyBalances(chainId, currencies) {
    ...
    var containsETH = React.useMemo(function () { var _a; return (_a = currencies === null || currencies === void 0 ? void 0 : currencies.some(function (currency) { return currency === ZERO_ADDRESS; })) !== null && _a !== void 0 ? _a : false; }, [currencies]);
...
var UpperRow = styled__default["default"](Container)(templateObject_1$2 || (templateObject_1$2 = __makeTemplateObject(["\n  &.reviewdetails {\n    border-top: 0.5px solid rgba(0, 0, 0, 0.5);\n    .orgprice {\n      max-height: 36px;\n      overflow-y: Scroll;\n      overflow-x: hidden;\n    }\n    .rowOuter {\n      font-size: 14px;\n    }\n  }\n"], ["\n  &.reviewdetails {\n    border-top: 0.5px solid rgba(0, 0, 0, 0.5);\n    .orgprice {\n      max-height: 36px;\n      overflow-y: Scroll;\n      overflow-x: hidden;\n    }\n    .rowOuter {\n      font-size: 14px;\n    }\n  }\n"])));
var InputBx = styled__default["default"].input(templateObject_2$2 || (templateObject_2$2 = __makeTemplateObject(["\n  background: #f2f2f2;\n  border: 0.5px solid rgba(0, 0, 0, 0.5);\n  border-radius: 5px;\n  padding: 4px 8px;\n"], ["\n  background: #f2f2f2;\n  border: 0.5px solid rgba(0, 0, 0, 0.5);\n  border-radius: 5px;\n  padding: 4px 8px;\n"])));
var BlkHeading = styled__default["default"].div(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  font-weight: 400;\n  font-size: 14px;\n  line-height: 19px;\n  margin-bottom: 6px;\n"], ["\n  font-weight: 400;\n  font-size: 14px;\n  line-height: 19px;\n  margin-bottom: 6px;\n"])));
var Row = styled__default["default"].div(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  padding-bottom: 10px;\n  &.orgprice {\n    padding-bottom: 0;\n    ", " {\n      font-size: 16px;\n    }\n    .flexchain {\n      display: flex;\n      flex-flow: wrap;\n      ", " {\n        margin-top: 4px;\n        margin-right: 10px;\n        font-size: 13px;\n        img {\n          height: 18px;\n          margin-right: 5px;\n        }\n      }\n    }\n  }\n  &.transaction {\n    margin-top: 10px;\n    ", " {\n      width: 100%;\n    }\n  }\n  &.slippage {\n    .flexslip {\n      display: flex;\n      align-items: center;\n      ", " {\n        background: linear-gradient(\n          89.74deg,\n          rgba(226, 126, 172, 0.2) 0.06%,\n          rgba(163, 92, 227, 0.2) 99.09%\n        ) !important;\n        color: #000000;\n        border: 1px solid rgba(163, 92, 227, 0.2) !important;\n        padding: 5px 18px !important;\n        margin-right: 12px !important;\n        display: flex;\n        align-items: Center;\n        svg {\n          margin-left: 12px;\n        }\n      }\n    }\n  }\n  ", " {\n    background: linear-gradient(89.74deg, rgba(226, 126, 172, 0.2) 0.06%, rgba(163, 92, 227, 0.2) 99.09%);\n    color: #000000;\n    border: 0;\n    padding: 6px 18px !important;\n    margin-right: 12px;\n  }\n  ", " {\n    width: 100%;\n  }\n"], ["\n  padding-bottom: 10px;\n  &.orgprice {\n    padding-bottom: 0;\n    ", " {\n      font-size: 16px;\n    }\n    .flexchain {\n      display: flex;\n      flex-flow: wrap;\n      ", " {\n        margin-top: 4px;\n        margin-right: 10px;\n        font-size: 13px;\n        img {\n          height: 18px;\n          margin-right: 5px;\n        }\n      }\n    }\n  }\n  &.transaction {\n    margin-top: 10px;\n    ", " {\n      width: 100%;\n    }\n  }\n  &.slippage {\n    .flexslip {\n      display: flex;\n      align-items: center;\n      ", " {\n        background: linear-gradient(\n          89.74deg,\n          rgba(226, 126, 172, 0.2) 0.06%,\n          rgba(163, 92, 227, 0.2) 99.09%\n        ) !important;\n        color: #000000;\n        border: 1px solid rgba(163, 92, 227, 0.2) !important;\n        padding: 5px 18px !important;\n        margin-right: 12px !important;\n        display: flex;\n        align-items: Center;\n        svg {\n          margin-left: 12px;\n        }\n      }\n    }\n  }\n  ", " {\n    background: linear-gradient(89.74deg, rgba(226, 126, 172, 0.2) 0.06%, rgba(163, 92, 227, 0.2) 99.09%);\n    color: #000000;\n    border: 0;\n    padding: 6px 18px !important;\n    margin-right: 12px;\n  }\n  ", " {\n    width: 100%;\n  }\n"])), BlkHeading, OutlineButton, InputBx, GradButton, GradButton, InputBx);
var DisplayBlock = styled__default["default"](Container)(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  border-top: 0.5px solid rgba(0, 0, 0, 0.5);\n  margin-top: 0px;\n  .txt {\n    font-weight: 400;\n    font-size: 16px;\n    line-height: 22px;\n  }\n"], ["\n  border-top: 0.5px solid rgba(0, 0, 0, 0.5);\n  margin-top: 0px;\n  .txt {\n    font-weight: 400;\n    font-size: 16px;\n    line-height: 22px;\n  }\n"])));
var FlexText = styled__default["default"].div(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n"], ["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n"])));
var ButtonControls = styled__default["default"].div(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  margin-top: 16px;\n  button {\n    border: 0;\n    min-width: 120px;\n    margin: 0 5px;\n  }\n  &.paymentreview {\n    justify-content: flex-start;\n\n    margin: 0 -5px;\n    margin-top: 8px;\n    button {\n      &:last-child {\n        width: 100%;\n      }\n    }\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  margin-top: 16px;\n  button {\n    border: 0;\n    min-width: 120px;\n    margin: 0 5px;\n  }\n  &.paymentreview {\n    justify-content: flex-start;\n\n    margin: 0 -5px;\n    margin-top: 8px;\n    button {\n      &:last-child {\n        width: 100%;\n      }\n    }\n  }\n"])));
// @ts-ignore
var DisplaySwitch = styled__default["default"](Switch__default["default"])(function (_a) {
    _a.theme;
    return ({
...
var SettingsWidget = function (props) {
    ...
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsxs(UpperRow, { children: [jsxRuntime.jsxs(Row, __assign({ className: "slippage" }, { children: [jsxRuntime.jsx(BlkHeading, { children: "Slippage" }), jsxRuntime.jsxs("div", __assign({ className: "flexslip" }, { children: [jsxRuntime.jsxs(GradButton, { children: ["Auto", jsxRuntime.jsx(GradtickIcon, {})] }), jsxRuntime.jsx(InputBx, { placeholder: "40 minutes" })] }))] })), jsxRuntime.jsxs(Row, __assign({ className: "transaction" }, { children: [jsxRuntime.jsx(BlkHeading, { children: "Transaction Details" }), jsxRuntime.jsx(InputBx, { placeholder: "40 minutes" })] }))] }), jsxRuntime.jsxs(DisplayBlock, { children: [jsxRuntime.jsx(BlkHeading, { children: "Display Settings" }), jsxRuntime.jsxs(FlexText, { children: [jsxRuntime.jsx("div", __assign({ className: "txt" }, { children: "Dark Mode" })), jsxRuntime.jsx(DisplaySwitch, __assign({}, label, { defaultChecked: true, color: "default" }))] }), jsxRuntime.jsxs(ButtonControls, { children: [jsxRuntime.jsx(CancelButton, { children: "Cancel" }), jsxRuntime.jsx(GradButton, { children: "Save" })] })] })] }));
};

function SelectItem(props) {
    return (jsxRuntime.jsxs("div", __assign({ className: "select_item  mb-3 ".concat(props.active && "active"), onClick: props.selectItem }, { children: [jsxRuntime.jsx("div", __assign({ className: "select_item_img" }, { children: props.item.image && (jsxRuntime.jsx(IconImage, { src: props.item.image, className: "w-full", alt: props.item.symbol, width: 20, height: 20 })) })), jsxRuntime.jsx("div", __assign({ className: "ms-2 flex-grow-1" }, { children: jsxRuntime.jsx("h4", __assign({ className: " mb-0" }, { children: props.item.symbol })) })), jsxRuntime.jsx("div", { className: "select_item_circle" })] })));
}

function SelectNetwork(props) {
    return (jsxRuntime.jsxs("div", __assign({ className: "selectsqitem select_item  mb-3 ".concat(props.active && "active"), onClick: props.selectItem }, { children: [jsxRuntime.jsx("div", __assign({ className: "select_item_img" }, { children: props.item.image && (jsxRuntime.jsx(IconImage, { src: props.item.image, className: "w-full", alt: props.item.symbol, width: 20, height: 20 })) })), jsxRuntime.jsx("div", __assign({ className: "chname" }, { children: props.item.name }))] })));
}

function TokenSelectModal(props) {
    var _a = __read(React.useState(""), 2), inputSearch = _a[0], setInputSearch = _a[1];
    var filterTokens = function (tokens, search) {
        if (!search || !search.length)
            return tokens;
        var searchingAddress = utils.isAddress(search);
        if (searchingAddress) {
    ...
    return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsxs(ChooseTokenOuter, { children: [jsxRuntime.jsx("div", __assign({ className: "searchboxOuter" }, { children: jsxRuntime.jsxs("div", __assign({ className: "d-flex align-items-center select_searchBox" }, { children: [jsxRuntime.jsx(reactBootstrap.FormControl, { className: "select_search_input", placeholder: "Search name or address", value: inputSearch, onChange: function (event) { return setInputSearch(event.target.value); } }), jsxRuntime.jsx(fi.FiSearch, { className: "me-2" })] })) })), jsxRuntime.jsxs("div", __assign({ className: "tokenselectionbox" }, { children: [jsxRuntime.jsx("div", __assign({ className: "tokenselectionleft" }, { children: filteredChains &&
                                filteredChains.map(function (item, index) { return (jsxRuntime.jsx(SelectNetwork, { item: item, active: item.chain_id === props.selectedNetwork, selectItem: function () {
                                        props.selectNetwork(item);
                                    } }, index)); }) })), jsxRuntime.jsx("div", __assign({ className: "tokenselectionright" }, { children: jsxRuntime.jsx("div", __assign({ className: "select_options" }, { children: filteredTokens &&
                                    filteredTokens.map(function (item, index) {
                                        var _a;
                                        return (jsxRuntime.jsx(SelectItem, { item: item, active: ((_a = item === null || item === void 0 ? void 0 : item.address) === null || _a === void 0 ? void 0 : _a.toLowerCase()) === props.selectedItem, selectItem: function () {
...
function TokenSelectData(_a) {
    ...
    var allTokens = useTokens().tokens;
    var _b = __read(React.useState([]), 2), tokens = _b[0], setTokens = _b[1];
    var _c = __read(React.useState(null), 2), selectedNetwork = _c[0], setSelectedNetwork = _c[1];
    var _d = __read(React.useState(null), 2), selectedItem = _d[0], setSelectedItem = _d[1];
    React.useEffect(function () {
        var _a, _b, _c;
        if (chainId && allTokens) {
            if (allTokens === null || allTokens === void 0 ? void 0 : allTokens[chainId]) {
    ...
    return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsx(TokenSelectModal, { chainId: chainId, options: tokens, selectNetwork: function (item) { return handleSelectNetwork(item); }, selectItem: function (item) { return handleSelectToken(item); }, selectedItem: selectedItem, selectedNetwork: selectedNetwork }) }));
}

var PaymentReview = function (props) {
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx(UpperRow, { children: jsxRuntime.jsxs(Row, __assign({ className: "orgprice" }, { children: [jsxRuntime.jsx(BlkHeading, { children: "Orignal Price: 0.045 ETH" }), jsxRuntime.jsxs("div", __assign({ className: "flexchain" }, { children: [jsxRuntime.jsxs(OutlineButton, { children: [jsxRuntime.jsx("img", { alt: "", src: "/logos/chains/binance.png" }), "Binance Smart Chain"] }), jsxRuntime.jsxs(OutlineButton, { children: [jsxRuntime.jsx("img", { alt: "", src: "/logos/chains/binance.png" }), "Binance Coin"] })] }))] })) }), jsxRuntime.jsx(UpperRow, __assign({ className: "reviewdetails" }, { children: jsxRuntime.jsxs(Row, __assign({ className: "orgprice" }, { children: [jsxRuntime.jsx(BlkHeading, { children: "Details:" }), jsxRuntime.jsxs("div", __assign({ className: "rowOuter" }, { children: [jsxRuntime.jsxs(FlexText, { children: [jsxRuntime.jsx("div", { children: "Network fees" }), jsxRuntime.jsx("div", { children: "5GWei" })] }), jsxRuntime.jsxs(FlexText, { children: [jsxRuntime.jsx("div", { children: "Relayer fees" }), jsxRuntime.jsx("div", { children: "0.005675 BNB" })] }), jsxRuntime.jsxs(FlexText, { children: [jsxRuntime.jsx("div", { children: "Rate conversion" }), jsxRuntime.jsx("div", { children: "1 ETH = 5.29 BNB" })] }), jsxRuntime.jsxs(FlexText, { children: [jsxRuntime.jsx("div", { children: "Slippage" }), jsxRuntime.jsx("div", { children: "0.01%" })] }), jsxRuntime.jsxs(FlexText, { children: [jsxRuntime.jsx("div", { children: "Slippage" }), jsxRuntime.jsx("div", { children: "0.01%" })] })] }))] })) })), jsxRuntime.jsxs(DisplayBlock, { children: [jsxRuntime.jsx(BlkHeading, { children: "Final Price:" }), jsxRuntime.jsxs(PriceBlock, { children: [jsxRuntime.jsxs("h2", { children: [jsxRuntime.jsx("img", { alt: "", src: "/logos/chains/binance.png" }), "1 BNB"] }), jsxRuntime.jsx("h5", { children: "($34.34)" })] }), jsxRuntime.jsxs(ButtonControls, __assign({ className: "paymentreview" }, { children: [jsxRuntime.jsx(CancelButton, { children: "Cancel" }), jsxRuntime.jsxs(GradButton, { children: [jsxRuntime.jsx(WalletIcon, {}), "Buy Now"] })] }))] })] }));
};

var PaymentStatus = function (props) {
    var status = props.status;
    return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsxs(StatusLoader, { children: [jsxRuntime.jsxs(StatusContent, { children: [status == "successful" ? jsxRuntime.jsx(SuccessIcon, {}) : null, status == "successful" ? jsxRuntime.jsx("h2", __assign({ style: { color: "#519F6C" } }, { children: "Payment Successful" })) : null, status == "error" ? jsxRuntime.jsx(FailedIcon, {}) : null, status == "error" ? jsxRuntime.jsx("h2", __assign({ style: { color: "#D54E40" } }, { children: "Payment Failed" })) : null, status == "pending" ? jsxRuntime.jsx(PendingIcon, {}) : null, status == "pending" ? jsxRuntime.jsx("h2", __assign({ style: { color: "#DDA125" } }, { children: "Payment Pending" })) : null, status == "error" ? jsxRuntime.jsx("h6", { children: "Not enough funds in the wallet" }) : null] }), status != "pending" ? jsxRuntime.jsx("button", { children: "Continue" }) : null] }) }));
};
var StatusLoader = styled__default["default"](Container)(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject(["\n  min-height: 295px;\n  display: flex;\n  flex-direction: column;\n  align-items: Center;\n  justify-content: center;\n  button {\n    background: #f2f2f2;\n    border: 1px solid rgba(0, 0, 0, 0.75);\n    border-radius: 5px;\n    padding: 4px 18px;\n    margin-top: 20px;\n  }\n"], ["\n  min-height: 295px;\n  display: flex;\n  flex-direction: column;\n  align-items: Center;\n  justify-content: center;\n  button {\n    background: #f2f2f2;\n    border: 1px solid rgba(0, 0, 0, 0.75);\n    border-radius: 5px;\n    padding: 4px 18px;\n    margin-top: 20px;\n  }\n"])));
var StatusContent = styled__default["default"].div(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  align-items: Center;\n  justify-content: center;\n  h2 {\n    font-weight: 700;\n    font-size: 20px;\n    line-height: 34px;\n    margin-top: 8px;\n    margin-bottom: 0;\n  }\n  h6 {\n    font-size: 14px;\n    font-weight: 300;\n  }\n"], ["\n  display: flex;\n  flex-direction: column;\n  align-items: Center;\n  justify-content: center;\n  h2 {\n    font-weight: 700;\n    font-size: 20px;\n    line-height: 34px;\n    margin-top: 8px;\n    margin-bottom: 0;\n  }\n  h6 {\n    font-size: 14px;\n    font-weight: 300;\n  }\n"])));
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    _c.label = 2;
                case 2:
                    formattedChainId = bytes.hexStripZeros(bignumber.BigNumber.from(chainId).toHexString());
                    _c.label = 3;
                case 3:
                    _c.trys.push([3, 5, , 13]);
...
var PaymentConfirm = function (props) {
    ...
    var _g = __read(React.useState(ActiveWidgetModal.Main), 2), widgetActive = _g[0], setWidgetActive = _g[1];
    var bridge = props.bridge, valid = props.valid;
    var isBrowserTabActiveRef = useIsBrowserTabActive();
    var _h = core.useWeb3React(), account = _h.account, chainId = _h.chainId, isActive = _h.isActive, provider = _h.provider;
    var tokens = useTokens().tokens;
    var _j = useNxtpSdk(0), sdk = _j.sdk, assetBalances = _j.assetBalances;
    var _k = __read(React.useState(), 2), bridgeState = _k[0], setBridgeState = _k[1];
    ...
    var nativeTokenPrices = useNativeTokenPrices().nativeTokenPrices;
    var _l = __read(React.useState(null), 2), controller = _l[0], setController = _l[1];
    var _m = __read(React.useState(null), 2), error = _m[0], setError = _m[1];
    var _o = __read(React.useState(null), 2), estimating = _o[0], setEstimating = _o[1];
    var _p = __read(React.useState(null), 2), estimateResponse = _p[0], setEstimateResponse = _p[1];
    var _q = __read(React.useState(null), 2), estimateCooldown = _q[0], setEstimateCooldown = _q[1];
    var _r = __read(React.useState(null), 2), estimateTrigger = _r[0], setEstimateTrigger = _r[1];
    var _s = __read(React.useState(null), 2), approving = _s[0], setApproving = _s[1];
    var _t = __read(React.useState(null), 2), approveResponse = _t[0], setApproveResponse = _t[1];
    var _u = __read(React.useState(null), 2), xcall = _u[0], setXcall = _u[1];
    var _v = __read(React.useState(null), 2), calling = _v[0], setCalling = _v[1];
    var _w = __read(React.useState(null), 2), xcallResponse = _w[0], setXcallResponse = _w[1];
    ...
    // );
    var fromTransactingToken = React.useMemo(function () {
    ...
    var hasSufficientBalance = React.useMemo(function () {
    ...
    var fromChainInfo = React.useMemo(function () {
        var _a;
    ...
    var toTransactingToken = React.useMemo(function () {
        ...
        if (typeof estimateCooldown === "number") {
            if (estimateCooldown === 0) {
                ...
                if (typeof fromTransactingAmount !== "number") {
                    setEstimateTrigger(moment__default["default"]().valueOf());
                }
            }
            else {
    ...
    React.useEffect(function () {
        ...
        if (fromChainId && toChainId && fromTransacting && new BigNumber__default["default"](relayerFee).gt(0) && assetBalances && toLocal) {
            setEstimateTrigger(moment__default["default"]().valueOf());
        }
    ...
    var estimateRelayerFee = function () {
        ...
        var gasOnToChain = new BigNumber__default["default"](gasPrice)
        ...
        return __generator(this, function (_k) {
            switch (_k.label) {
                ...
                case 3:
                    ...
                    toast__default["default"].success("Wait for ".concat(fromTransactingInfo.symbol, " approval"));
                ...
                case 4:
                    ...
                    toast__default["default"].error("Failed to approve ".concat(fromTransactingInfo.symbol));
                ...
                case 6:
                    ...
                    failed = true;
                    setApproving(false);
                    toast__default["default"].error(((_c = error_2 === null || error_2 === void 0 ? void 0 : error_2.data) === null || _c === void 0 ? void 0 : _c.message) || (error_2 === null || error_2 === void 0 ? void 0 : error_2.message));
                    return [3 /*break*/, 7];
                case 7:
                ...
                case 10:
                    ...
                    if (gas_limit) {
                        gas_limit = ethers.FixedNumber.fromString(gas_limit)
                            .mulUnsafe(ethers.FixedNumber.fromString("1.3"))
                            .round(0)
                            .toString()
                            .replace(".0", "");
                ...
                case 12:
                    ...
                    if (failed) {
                        toast__default["default"].error("Failed to send transaction");
                    }
                    else {
                        toast__default["default"].success("".concat(fromTransactingInfo.symbol, " transfer detected, waiting for execution."));
                    }
                    _k.label = 13;
                ...
                case 14:
                    ...
                    toast__default["default"].error(errorMessage);
                    failed = true;
                    return [3 /*break*/, 15];
                case 15:
                    if (failed) {
    ...
    return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsxs(FibpalWidget, __assign({ className: "fibpalwidget" }, { children: [jsxRuntime.jsxs(WidgetHeader, { children: [jsxRuntime.jsxs(LeftHeader, { children: [widgetActive === ActiveWidgetModal.Main ? (jsxRuntime.jsx(PriceBlock, { children: jsxRuntime.jsxs(Container, { children: [jsxRuntime.jsxs("h2", { children: [jsxRuntime.jsx("img", { src: toTransactingToken && toTransactingToken.image, alt: "" }), (bridgeState === null || bridgeState === void 0 ? void 0 : bridgeState.toTransactingAmount) || 0, " ", (toTransactingToken === null || toTransactingToken === void 0 ? void 0 : toTransactingToken.symbol) || ""] }), jsxRuntime.jsxs("h5", { children: ["($", formatNumber((bridgeState === null || bridgeState === void 0 ? void 0 : bridgeState.toTransactingAmount) * (toTransactingToken === null || toTransactingToken === void 0 ? void 0 : toTransactingToken.priceUsd), 2), ")"] })] }) })) : null, widgetActive === ActiveWidgetModal.ConnectWallet ? jsxRuntime.jsx(HeaderName, { children: "Connect Wallet" }) : null, widgetActive === ActiveWidgetModal.Settings ? jsxRuntime.jsx(HeaderName, { children: "Settings" }) : null, widgetActive === ActiveWidgetModal.TokenSelect ? jsxRuntime.jsx(HeaderName, { children: "Choose a Token" }) : null, widgetActive === ActiveWidgetModal.PaymentReview ? jsxRuntime.jsx(HeaderName, { children: "Payment Review" }) : null, widgetActive === ActiveWidgetModal.PaymentStatus ? jsxRuntime.jsx(HeaderName, { children: "Payment Status" }) : null] }), jsxRuntime.jsxs(RightHeader, { children: [widgetActive === ActiveWidgetModal.Main ? (jsxRuntime.jsx(Settings, __assign({ onClick: function () { return setWidgetActive(ActiveWidgetModal.Settings); } }, { children: jsxRuntime.jsx(SettingsIcon, {}) }))) : null, widgetActive === ActiveWidgetModal.Settings ||
                                    ...
                                    widgetActive === ActiveWidgetModal.PaymentReview ? (jsxRuntime.jsx(Close, __assign({ onClick: function () { return setWidgetActive(ActiveWidgetModal.Main); } }, { children: jsxRuntime.jsx(CloseIcon, {}) }))) : null] })] }), jsxRuntime.jsxs("div", __assign({ className: "widgetcontentmiddle" }, { children: [widgetActive === ActiveWidgetModal.Main ? (jsxRuntime.jsxs(WidgetContent, { children: [jsxRuntime.jsxs(CoinSelectorDD, { children: [jsxRuntime.jsx("div", __assign({ className: "tokeninner", onClick: function () { return setWidgetActive(ActiveWidgetModal.TokenSelect); } }, { children: jsxRuntime.jsx(TokenSelect, { chainId: (_a = bridgeState === null || bridgeState === void 0 ? void 0 : bridgeState.fromChainId) !== null && _a !== void 0 ? _a : (fromChainInfo ? fromChainInfo.chain_id : null), assetId: (_b = bridgeState === null || bridgeState === void 0 ? void 0 : bridgeState.fromTransacting) !== null && _b !== void 0 ? _b : ZERO_ADDRESS }) })), estimateResponse && (jsxRuntime.jsxs("div", __assign({ className: "valueconverted" }, { children: ["1 ", (toTransactingToken === null || toTransactingToken === void 0 ? void 0 : toTransactingToken.symbol) || "", " =", " ", estimateResponse
                                                    ...
                                                    : "-"] })))] }), jsxRuntime.jsxs(TotalPrice, { children: [jsxRuntime.jsx("h6", { children: "Total Price:" }), jsxRuntime.jsxs("h2", { children: [jsxRuntime.jsx("img", { src: fromTransactingToken ? fromTransactingToken.image : fromChainInfo && fromChainInfo.image, className: "tokenimg", alt: "" }), estimateResponse
                                                    ...
                                                    : "-"] })] }), jsxRuntime.jsx(StatusButtons, { children: !(isActive && Boolean(account)) ? (jsxRuntime.jsx("button", __assign({ className: "complete", onClick: function () { return setWidgetActive(ActiveWidgetModal.ConnectWallet); } }, { children: jsxRuntime.jsx("p", __assign({ className: "d-inline-block fw-bold mb-0" }, { children: "Connect Wallet" })) }))) : chainId && (chainId == (bridgeState === null || bridgeState === void 0 ? void 0 : bridgeState.toChainId) || !isSupportedChain(chainId)) ? (jsxRuntime.jsx("button", __assign({ className: "complete", onClick: function () { } }, { children: jsxRuntime.jsx("p", __assign({ className: "d-inline-block  fw-bold mb-0" }, { children: "Unsupported Network" })) }))) : chainId &&
                                        ...
                                        chainId !== (bridgeState === null || bridgeState === void 0 ? void 0 : bridgeState.fromChainId) ? (jsxRuntime.jsx("button", __assign({ className: "complete", onClick: function () { return switchToNetwork({ library: provider, chainId: bridgeState.fromChainId }); } }, { children: jsxRuntime.jsx("p", __assign({ className: "d-inline-block  fw-bold mb-0" }, { children: "Switch Network" })) }))) : !valid ? (jsxRuntime.jsx("button", __assign({ className: "complete", onClick: function () { } }, { children: jsxRuntime.jsx("p", __assign({ className: "d-inline-block fw-bold mb-0" }, { children: "Unsupported" })) }))) : error ? (jsxRuntime.jsx("button", __assign({ className: "complete", onClick: function () { }, disabled: true }, { children: jsxRuntime.jsx("p", __assign({ className: "d-inline-block  fw-bold mb-0" }, { children: error && error.length <= 50 ? error : "Error" })) }))) : estimating ? (jsxRuntime.jsx("button", __assign({ className: "complete", onClick: function () { }, disabled: true }, { children: jsxRuntime.jsx("p", __assign({ className: "d-inline-block fw-bold mb-0" }, { children: "Estimating..." })) }))) : approving ? (jsxRuntime.jsx("button", __assign({ className: "complete", onClick: function () { }, disabled: true }, { children: jsxRuntime.jsx("p", __assign({ className: "d-inline-block  fw-bold mb-0" }, { children: "Approving..." })) }))) : calling ? (jsxRuntime.jsx("button", __assign({ className: "complete", onClick: function () { }, disabled: true }, { children: jsxRuntime.jsx("p", __assign({ className: "d-inline-block fw-bold mb-0" }, { children: "Transferring..." })) }))) : !estimateResponse ? (jsxRuntime.jsx("button", __assign({ className: "complete", onClick: function () { }, disabled: true }, { children: jsxRuntime.jsx("p", __assign({ className: "d-inline-block fw-bold mb-0" }, { children: "Loading..." })) }))) : estimateResponse && !hasSufficientBalance ? (jsxRuntime.jsx("button", __assign({ className: "complete", onClick: function () { }, disabled: true }, { children: jsxRuntime.jsx("p", __assign({ className: "d-inline-block  fw-bold mb-0" }, { children: "Insufficient Balance" })) }))) : estimateResponse ? (jsxRuntime.jsx("button", __assign({ className: "complete", onClick: call, disabled: !estimateResponse }, { children: jsxRuntime.jsxs("p", __assign({ className: "d-inline-block fw-bold mb-0" }, { children: [" ", jsxRuntime.jsx(WalletIcon, {}), " Complete Purchase"] })) }))) : null })] })) : null, widgetActive === ActiveWidgetModal.TokenSelect ? (jsxRuntime.jsx(WidgetContent, { children: jsxRuntime.jsx(TokenSelectData, { chainId: (_e = bridgeState === null || bridgeState === void 0 ? void 0 : bridgeState.fromChainId) !== null && _e !== void 0 ? _e : (fromChainInfo ? fromChainInfo.chain_id : null), assetId: (_f = bridgeState === null || bridgeState === void 0 ? void 0 : bridgeState.fromTransacting) !== null && _f !== void 0 ? _f : ZERO_ADDRESS, onSelectToken: function (assetId) {
                                    handleChangeFromToken(assetId);
                                }, onSelectNetwork: function (chainId) {
                                    handleChangeFromChain(chainId);
                                } }) })) : null, widgetActive === ActiveWidgetModal.Settings ? (jsxRuntime.jsx(WidgetContent, { children: jsxRuntime.jsx(SettingsWidget, {}) })) : null, widgetActive === ActiveWidgetModal.PaymentReview ? (jsxRuntime.jsx(WidgetContent, { children: jsxRuntime.jsx(PaymentReview, {}) })) : null, widgetActive === ActiveWidgetModal.PaymentStatus ? (jsxRuntime.jsx(WidgetContent, { children: jsxRuntime.jsx(PaymentStatus, { status: "pending" }) })) : null, widgetActive === ActiveWidgetModal.ConnectWallet ? (jsxRuntime.jsx(WidgetContent, { children: jsxRuntime.jsx(ConnectWalletModal, { show: true, onHide: function () { return setWidgetActive(ActiveWidgetModal.Main); } }) })) : null] })), widgetActive !== ActiveWidgetModal.TokenSelect && widgetActive !== ActiveWidgetModal.Settings ? (jsxRuntime.jsxs(WidgetFooter, { children: [jsxRuntime.jsx("div", __assign({ className: "powered" }, { children: "Powered by FibPal" })), widgetActive === ActiveWidgetModal.PaymentStatus ? (jsxRuntime.jsx("a", __assign({ href: "#" }, { children: jsxRuntime.jsx(BscscanIcon, {}) }))) : (jsxRuntime.jsxs("div", __assign({ className: "feeblock" }, { children: ["Fees ", SWAP_FEE, "%"] })))] })) : null] })) }));
};

function Wallet(_a) {
    _a.disabled;
    // Attempt to connect eagerly on mount
    var defaultChainId = utils$1.useAtomValue(defaultChainIdAtom);
    React.useEffect(function () {
...
var PaymentWidget = function (props) {
    ...
    var _a = __read(React.useState(), 2), bridgeState = _a[0], setBridgeState = _a[1];
    var _b = __read(React.useState(true), 2), valid = _b[0], setValid = _b[1];
    var _c = __read(React.useState(null), 2); _c[0]; var setError = _c[1];
    ...
    var _d = __read(React.useState(null), 2); _d[0]; _d[1];
    ...
    var jsonRpcUrlMap = React.useMemo(function () {
        var e_1, _a;
    ...
    React.useEffect(function () {
        if (order) {
            ...
            if (!utils.isAddress(order.toTo) || !order.toData || order.toData === "0x") {
                setValid(false);
                setBridgeState(null);
    ...
    return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsx(React__default["default"].StrictMode, { children: jsxRuntime.jsx(WidgetWrapper, __assign({ width: width, className: className }, { children: jsxRuntime.jsx(ActiveWeb3Provider, __assign({ provider: provider, jsonRpcUrlMap: jsonRpcUrlMap, defaultChainId: defaultChainId }, { children: jsxRuntime.jsx(RefreshContextProvider, { children: jsxRuntime.jsx(TokensContextProvider, __assign({ defaultTokens: tokenList }, { children: jsxRuntime.jsxs(TokenPriceContextProvider, { children: [jsxRuntime.jsx(GlobalStyle, {}), jsxRuntime.jsx(Wallet, {}), jsxRuntime.jsx(PaymentConfirm, __assign({}, props, { bridge: bridgeState, valid: valid }))] }) })) }) })) })) }) }));
};
...
var WidgetWrapper = styled__default["default"].div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  -moz-osx-font-smoothing: grayscale;\n  -webkit-font-smoothing: antialiased;\n  -webkit-tap-highlight-color: rgba(0, 0, 0, 0);\n  border-radius: 0.1em;\n  box-sizing: border-box;\n  display: flex;\n  flex-direction: column;\n  font-feature-settings: \"ss01\" on, \"ss02\" on, \"cv01\" on, \"cv03\" on;\n  font-size: 16px;\n  font-smooth: always;\n  font-variant: none;\n  // height: 400px;\n  min-width: 400px;\n  padding: 0.25em;\n  position: relative;\n  user-select: none;\n  width: ", ";\n\n  * {\n    box-sizing: border-box;\n    font-family: \"Inter\", sans-serif;\n\n    @supports (font-variation-settings: normal) {\n      font-family: \"Inter\", sans-serif;\n    }\n  }\n"], ["\n  -moz-osx-font-smoothing: grayscale;\n  -webkit-font-smoothing: antialiased;\n  -webkit-tap-highlight-color: rgba(0, 0, 0, 0);\n  border-radius: 0.1em;\n  box-sizing: border-box;\n  display: flex;\n  flex-direction: column;\n  font-feature-settings: \"ss01\" on, \"ss02\" on, \"cv01\" on, \"cv03\" on;\n  font-size: 16px;\n  font-smooth: always;\n  font-variant: none;\n  // height: 400px;\n  min-width: 400px;\n  padding: 0.25em;\n  position: relative;\n  user-select: none;\n  width: ", ";\n\n  * {\n    box-sizing: border-box;\n    font-family: \"Inter\", sans-serif;\n\n    @supports (font-variation-settings: normal) {\n      font-family: \"Inter\", sans-serif;\n    }\n  }\n"])), function (_a) {
    var width = _a.width;
...
var FibapalWidget = function (props) {
    ...
    return jsxRuntime.jsx(PaymentWidget, { order: orderprop ? orderprop : order });
};

module.exports = FibapalWidget;
